...
the JAR name `sonarqube_demo_project-1.0-SNAPSHOT`, the script includes the following line.

```bash
exec java --enable-preview -jar target/sonarqube_demo_project-1.0-SNAPSHOT.jar "$@"
```